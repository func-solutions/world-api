...
object Rotation {
    ...
    fun rotate(degrees: Double, axis: V3, dot: V3) = multiplyMatrixToVector(
        getRotationMatrixByOrt(Math.toRadians(degrees), axis.x, axis.y, axis.z), doubleArrayOf(dot.x, dot.y, dot.z)
    )
    ...
    fun multiplyMatrixToVector(matrix: Array<DoubleArray>, vector: DoubleArray): V3 {
